    ...
    return(
            ...
            <div className="flex flex-col  md:flex-row shadow-lg dark:shadow-gray-50 dark:drop-shadow-2xl border-b-2 dark:border-b-0 bg-white  dark:bg-transparent py-12 overflow-hidden min-h-96 sm:max-w-full lg:min-w-full md:min-w-full md:w-3/4 lg:mx-auto px-auto ">
                ...
                <div className="w-full md:w-1/2  ml-5 min-h-full flex flex-col  items-start justify-center mt-16 ">
                    <h2 className="text-lg lg:text-2xl font-bold dark:text-secondary-dark  text-gray-800 mb-5">
                    {project.title}
                    </h2>
                    <p className="dark:text-gray-300 text-primary-light text-sm lg:text-lg mb-4 pb-2 w-3/4 ">
                    {project.description}
                    </p>
